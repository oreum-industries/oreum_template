# End-User License Agreement (EULA) of `oreum_template`

This End-User License Agreement ("EULA") is a legal agreement between you and
Oreum OÜ t/a Oreum Industries, Sepapaja 6, Tallinn, 15551, Estonia,
reg.16122291, [oreum.io](https://oreum.io)

This EULA agreement governs your acquisition and use of our `oreum_template`
...
process and using the `oreum_template` software. It provides a license to use the
`oreum_template` software and contains warranty information and liability
disclaimers.

If you register for a free trial of the `oreum_template` software, this EULA
agreement will also govern that trial. By clicking "accept" or installing
and/or using the `oreum_template` software, you are confirming your acceptance of
...
to use the `oreum_template` software on your devices in accordance with the terms
of this EULA agreement.

You are permitted to load the `oreum_template` software onto a device (e.g. a
